...
```json
{"source": "youtube", "target": "[configured-endpoint]
```
Transcribe a video to text:
```json
{"target": "[configured-endpoint] "source": "youtube"}
```
Transcribe a podcast episode audio URL:
```json
{"target": "[configured-endpoint] "source": "podcast"}
```

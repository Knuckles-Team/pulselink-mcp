---
name: pulselink-starter
description: >-
  Pulselink API + MCP Server + A2A Server Use when working with Pulselink via this package's MCP
...
license: MIT
tags: [pulselink-starter, starter, mcp]
metadata:
  author: Genius
  version: '0.1.0'
---

# Pulselink Starter Skill

Starter skill for the **Pulselink** package. Use the `mcp-client` universal skill

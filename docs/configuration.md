...
This page is the operator contract for `pulselink-mcp`. Package-specific endpoint,
...
agents; expose verbose per-operation tools only for explicit operator diagnostics.
